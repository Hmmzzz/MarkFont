...
当前版本为 [`v0.3.7`](https://github.com/Hmmzzz/MarkFont/tree/v0.3.7)，可从
...
- iOS 16–17 导入含多个苹方候选的字体包时，自动选择标点更紧凑的“专版”候选
...
> iOS 16 conventional rootless 与其他组合仍欢迎社区验证。`v0.3.7` 的 iOS 16–17 苹方
> “专版”自动优选已通过回归、双包审计和实机验证；`v0.3.5` 的文件选择器修复仍待开启
> “粗体文本”的实机复测。
